...
# langchain-ai/langchain-google  | MIT     | https://github.com/langchain-ai/langchain-google/blob/main/libs/genai/langchain_google_genai/_genai_extension.py
...
def _prepare_config(
    ...
    _logger.info("Within _prepare_config, base_url is %s", base_url)
...
def build_generative_service(
    ...
    _logger.info("Within build_generative_service, base_url is %s", base_url)
